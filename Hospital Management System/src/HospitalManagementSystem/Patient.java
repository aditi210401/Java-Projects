...
public class Patient {
    ...
    public void addPatient() {
        ...
        System.out.println("Enter Patients Contact Number:");
        int contactnumber = scanner.nextInt();

        try {
            String query = "INSERT INTO patients(name, age, gender, contactnumber) values(?,?,?,?)";
    ...
    public void viewPatients() {
        ...
        try {
            ...
            System.out.println("+------------+--------------------------+------------+-------------+------------------+");
            System.out.println("| Patient Id | Name                     | Age        | Gender      | Contact No.      |");
            System.out.println("+------------+--------------------------+------------+-------------+------------------+");
            while (resultSet.next()) {
                ...
                System.out.printf("|%-12s|%-26s|%-12s|%-13s|%-18s|\n", id, name, age, gender, contactnumber);
                System.out.println("+------------+--------------------------+------------+-------------+------------------+");
            }
        } catch (SQLException e) {
            e.printStackTrace();
